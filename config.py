...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "shadow slayer")
#OWNER ID
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002478447336"))
#put 0 to disable
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002276776505"))#put 0 to disable
...
TOKEN = False if os.environ.get('TOKEN', "True") == "False" else True 
